...
class IndexPage(BasePage):
    ...
    #Panel Left -- INSIGHT
    _panel_insight_loc = {
        '_insight_talk_loc' : (By.XPATH, '/html/body/div[1]/div[5]/div/div[1]/ul/li[4]/div[2]/div/ul/li[1]/a'),
        '_insight_price_alert_loc' : (By.XPATH, '/html/body/div[1]/div[5]/div/div[1]/ul/li[4]/div[2]/div/ul/li[2]/a')
    }
    ...
    def check_all_panel_left(self):
        ...
        for each_element_at_my_shop_panel in self._panel_my_shop_loc:
            ...
            #print (*self._panel_my_shop_loc[each_element_at_my_shop_panel]) #For debug
        ...
        for each_element_at_insight_panel in self._panel_insight_loc:
            ...
            #print (*self._panel_insight_loc[each_element_at_insight_panel]) #For debug
...
def now_at_index(driver):
    ...
    user_profile.setDeposit(int(user_profile.getDeposit())-100000)
    user_profile.getDeposit()
